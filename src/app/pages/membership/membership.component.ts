...
export class MembershipComponent implements OnInit {
  ...
  public genderOption:string | null;
  ...
  public openMenuAssign(event: any){
  ...
  public closeMenuAssign(event: any){
    let parent = event.target.parentNode;
    while (parent){
      parent = parent.parentNode;
      if(parent.classList.contains('content')){
  ...
  public assignMenuItemsToUser(user: User){  
  ...
  public openModal(modalContent: any, user: any) {
    if(user){
      this.user = user;
